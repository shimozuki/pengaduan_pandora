                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-lg-7 col-md-9 ">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInLeft" data-delay=".4s">Pengaduan Online Rakyat</h1>
                                    <p data-animation="fadeInLeft" data-delay=".6s">Sampaikan laporan Anda langsung kepada instansi pemerintah berwenang Melalu Aplikasi Si Ujang Anda bisa langsung terhubung dengan pemerintah Kabupaten Bogor.</p>
                                    <!-- Hero-btn -->
                                    @guest
